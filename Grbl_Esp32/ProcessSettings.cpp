...
std::map<uint8_t, const char*> ErrorCodes = {
    ...
    {
        STATUS_P_PARAM_MAX_EXCEEDED,
        "P param max exceeded",
    },
    {
        STATUS_SD_FAILED_MOUNT,
        "SD failed mount",
    },
    {
    ...
    {
        STATUS_SD_FAILED_OPEN_DIR,
        "SD failed to open directory",
    },
    {
        STATUS_SD_DIR_NOT_FOUND,
        "SD directory not found",
    },
    {
        STATUS_SD_FILE_EMPTY,
        "SD file empty",
    },
    {
        STATUS_SD_FILE_NOT_FOUND,
        "SD file not found",
    },
    {
        STATUS_SD_FAILED_OPEN_FILE,
        "SD failed to open file",
    },
    {
        STATUS_SD_FAILED_BUSY,
        "SD is busy",
    },
    {
        STATUS_SD_FAILED_DEL_DIR,
        "SD failed to delete directory",
    },
    {
        STATUS_SD_FAILED_DEL_FILE,
        "SD failed to delete file",
    },
    {
