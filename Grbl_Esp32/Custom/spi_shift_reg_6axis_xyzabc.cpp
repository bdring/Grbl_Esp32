...
void machine_init() {
    ...
    /*
        ...
        HAL_digitalWrite(GPIO_NUM_I2S_IOEXP_24, HIGH);
        HAL_digitalWrite(GPIO_NUM_I2S_IOEXP_25, HIGH);
        HAL_digitalWrite(GPIO_NUM_I2S_IOEXP_26, HIGH);
        HAL_digitalWrite(GPIO_NUM_I2S_IOEXP_27, HIGH);
        HAL_digitalWrite(GPIO_NUM_I2S_IOEXP_28, HIGH);
        HAL_digitalWrite(GPIO_NUM_I2S_IOEXP_29, HIGH);
        HAL_digitalWrite(GPIO_NUM_I2S_IOEXP_30, HIGH);
        HAL_digitalWrite(GPIO_NUM_I2S_IOEXP_31, HIGH);
      */
}
#endif
