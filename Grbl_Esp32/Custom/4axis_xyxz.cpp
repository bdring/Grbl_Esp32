/*
	...
	first Z probe before tool change. Only executed once, because then we큞l know the initial Z height.
...
/*
   VARIABLES
*/
uint8_t AmountOfToolChanges; //  Each new tool increases this by 1. Before first tool, it큦 0.
...
{
	// let큦 start with the state machine	
