...
#define Y2_STEP_PIN              GPIOout(15)  // Z on schem
#define Y2_DIRECTION_PIN         GPIOout(2)   // Z on schem
...
#define Z_STEP_PIN              GPIOout(33) // A on schem
#define Z_DIRECTION_PIN         GPIOout(32) // A on schem
