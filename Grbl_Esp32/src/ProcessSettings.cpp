...
bool auth_failed(Word* w, const char* value, WebUI::auth_t auth_level) {
    permissions_t permissions = w->getPermissions();
    switch (auth_level) {
        case WebUI::auth_t::LEVEL_ADMIN:  // Admin can do anything
            return false;                 // Nothing is an Admin auth fail
        case WebUI::auth_t::LEVEL_GUEST:  // Guest can only access open settings
            return permissions != WG;     // Anything other than RG is Guest auth fail
        case WebUI::auth_t::LEVEL_USER:   // User is complicated...
...
uint8_t jog_set(uint8_t* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
...
err_t show_grbl_help(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    report_grbl_help(out->client());
    return STATUS_OK;
}

err_t report_gcode(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
...
err_t report_normal_settings(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    show_grbl_settings(out, GRBL, false);  // GRBL non-axis settings
    show_grbl_settings(out, GRBL, true);   // GRBL axis settings
    return STATUS_OK;
}
err_t report_extended_settings(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    show_grbl_settings(out, GRBL, false);      // GRBL non-axis settings
...
err_t list_grbl_names(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    for (Setting* s = Setting::List; s; s = s->next()) {
...
err_t list_settings(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    for (Setting* s = Setting::List; s; s = s->next()) {
...
err_t list_commands(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
...
err_t toggle_check_mode(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
...
err_t disable_alarm_lock(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
...
err_t report_ngc(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
...
err_t home_all(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    return home(HOMING_CYCLE_ALL);
}
err_t home_x(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    return home(HOMING_CYCLE_X);
}
err_t home_y(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    return home(HOMING_CYCLE_Y);
}
err_t home_z(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    return home(HOMING_CYCLE_Z);
}
err_t home_a(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    return home(HOMING_CYCLE_A);
}
err_t home_b(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    return home(HOMING_CYCLE_B);
}
err_t home_c(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    return home(HOMING_CYCLE_C);
}
err_t sleep_grbl(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    system_set_exec_state_flag(EXEC_SLEEP);
    return STATUS_OK;
}
err_t get_report_build_info(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    if (!value) {
        char line[128];
...
err_t report_startup_lines(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
...
err_t restore_settings(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    if (!value) {
        return STATUS_INVALID_STATEMENT;
    }
...
err_t showState(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    grbl_sendf(out->client(), "State 0x%x\r\n", sys.state);
    return STATUS_OK;
}
err_t doJog(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
...
err_t listErrorCodes(const char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
    if (value) {
        char*   endptr      = NULL;
...
err_t do_command_or_setting(const char* key, char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream* out) {
...
uint8_t system_execute_line(char* line, WebUI::ESPResponseStream* out, WebUI::auth_t auth_level) {
...
uint8_t system_execute_line(char* line, uint8_t client, WebUI::auth_t auth_level) {
