...
namespace Spindles {
    ...
    void VFD::init() {
        ...
        if (uart_set_pin(VFD_RS485_UART_PORT,
                         _txd_pin.getNative(Pin::Capabilities::Native),
                         _rxd_pin.getNative(Pin::Capabilities::Native),
                         _rts_pin.getNative(Pin::Capabilities::Native),
