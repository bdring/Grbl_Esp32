...
uint8_t execute_line(char* line, uint8_t client, WebUI::auth_t auth_level);
uint8_t system_execute_line(char* line, WebUI::ESPResponseStream*, WebUI::auth_t);
uint8_t system_execute_line(char* line, uint8_t client, WebUI::auth_t);
uint8_t do_command_or_setting(const char* key, char* value, WebUI::auth_t auth_level, WebUI::ESPResponseStream*);
